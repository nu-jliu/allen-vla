#!/usr/bin/env python
"""
Inference Server for Diffusion policy.

This server loads a trained Diffusion policy and handles inference requests over TCP.
...
class InferenceServer:
    ...
    def _load_policy_fallback(self, policy_cfg: PreTrainedConfig) -> None:
        ...
        logger.info("Loading Diffusion policy directly from checkpoint...")
        self.policy = DiffusionPolicy.from_pretrained(self.checkpoint)
    ...
    def start(self, host: str = "0.0.0.0", port: int = 8000) -> None:
        ...
        """
        logger.info("=" * 60)
        logger.info("Diffusion Policy Inference Server")
        logger.info("=" * 60)
        logger.info("")
...
def parse_args() -> Namespace:
    ...
    parser = ArgumentParser(
        description="Diffusion Policy Inference Server",
