...
# Download script to sync data directory from remote Jetson machine
# Usage: ./scripts/download_data.bash <username> <hostname>
# Example: ./scripts/download_data.bash allen jetson
...
REMOTE_DIR="/home/${USERNAME}/.ws/vla_ws/data/"
...
echo "================================================"
echo "Downloading data from: ${SSH_TARGET}:${REMOTE_DIR}"
